...
class taxinvoicefrm extends JFrame implements ActionListener,ItemListener
{
...
//JTextField txtappvat=new JTextField();
JTextField txtvatno=new JTextField();
...
//JTextField txtpaymode=new JTextField();
...
p1.setBounds(50,70,690,120);
p1.setLayout(new GridLayout(5,4,10,5));
p1.add(lblino);p1.add(txtino);p1.add(lblcname);p1.add(txtito1);
p1.add(lblidate);p1.add(txtidate);p1.add(e1);p1.add(txtito2);
p1.add(lblappvat);p1.add(comvat);p1.add(e2);p1.add(txtito3);
p1.add(lblvatno);p1.add(txtvatno);p1.add(lblpaymode);p1.add(compmode);
p1.add(lbltin);p1.add(txttin);
...
public void actionPerformed(ActionEvent e)
{
	...
	String s8=txtvatno.getText();
	String s9=txttin.getText();
	String s10=txttotal.getText();
	String s11=txtdis.getText();
	String s12=txtvalamt.getText();
	String s13=txttvat.getText();
	String s14=txtnet.getText();
	...
	String sql="insert into taxmaster values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"','"+s11+"','"+s12+"','"+s13+"','"+s14+"')";
